...
const colorByStat = {
  ...
  DEF: "[&>div]:bg-yellow-400 bg-slate-100",
  SpA: "[&>div]:bg-blue-300 bg-slate-100",
  SpD: "[&>div]:bg-green-400 bg-slate-100",
  SPD: "[&>div]:bg-pink-300 bg-slate-100",
  TOT: "[&>div]:bg-blue-400 bg-blue-300",
};
  ...
  return (
    ...
    >
      <button
        ...
        className="bg-white absolute top-4 right-4 p-1 rounded-lg hover:opacity-80 trasition-opacity"
      >
        <IconX size={32} stroke={4} />
      </button>
      <article
        className={`bg-white h-[85%] absolute w-full rounded-tl-3xl rounded-tr-3xl 
      ...
      >
        ...
        <div className="overflow-y-auto px-4 pt-12 grid gap-2 content-start h-full hidden-scroll">
          ...
          <section className="grid gap-2">
            <h4 className="font-bold capitalize">Evolution</h4>
